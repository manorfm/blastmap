...
from blastmap.export.mermaid import export_mermaid
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_update.add_argument("service", help="Exact name shown by `blastmap list`")
    ...
    p_export = sub.add_parser(
        ...
        epilog=(
            ...
            "  blastmap export mermaid --out docs/\n"
        ),
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
